...
export default function Bio() {
    return (
        <div  className="textColorWhite bioContent ml-5">
            ...
            <br/>
            In late 2017 he signed on to The Brown Agency where he continues to work as a commercial print model & actor. He has appeared in ads for companies such as Amazon, Apple, Dell, LegalZoom, Bayer, H-E-B, Kevita, Ascension, and ConocoPhilips among others. <div/>
            <br/>
