    ...
    <div>
      <div className="d-block w-100">
        <Carousel>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Fashion2} alt="Second slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Fashion3} alt="Third slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Fashion4} alt="Fourth slide" />
