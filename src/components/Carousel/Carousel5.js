  ...
  return (
    <div>
      <div className="d-block w-50 mt-2 mb-2">
        <Carousel>
          <Carousel.Item>
            <img className="d-block w-100" src={Jacket1} alt="First slide" />
            <Carousel.Caption>
              <h3></h3>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Jacket2} alt="Second slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Jacket3} alt="Third slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Jacket4} alt="Fourth slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Jacket5} alt="Fifth slide" />
